...
def orchestrate(request: dict[str, Any], run_root_parent: Path = DEFAULT_RUN_ROOT) -> dict[str, Any]:
    ...
    ai_record = {
        ...
        "generationAttempts": ai_status.get("generationAttempts"),
        "reason": ai_status.get("reason"),
        "temperature": ai_status.get("temperature"),
        "styleVariant": ai_status.get("styleVariant"),
        "promptTokens": ai_status.get("promptTokens"),
        "responseTokens": ai_status.get("responseTokens"),
        "promptTokensTotal": ai_status.get("promptTokensTotal"),
        "responseTokensTotal": ai_status.get("responseTokensTotal"),
        "fallbackOutputSha256": ai_status.get("fallbackOutputSha256"),
        "modelOutputSha256": ai_status.get("modelOutputSha256"),
        "modelOutputChangedFromFallback": ai_status.get("modelOutputChangedFromFallback"),
