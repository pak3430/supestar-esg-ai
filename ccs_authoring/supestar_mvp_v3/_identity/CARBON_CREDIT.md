---
name: CARBON_CREDIT
description: "탄소크레딧의 산림 ESG 문맥상 의미와 경계를 정의한다."
...
fragmentedFrom: none
collapsedFrom: none
sequencePreviousIdentity: "[EMISSION_ALLOWANCE](../_artifact/stage3_knowledge_chain_ordering_artifact.md#orderedcandidaterecords)"
sequenceNextIdentity: "[CARBON_OFFSET](../_artifact/stage3_knowledge_chain_ordering_artifact.md#orderedcandidaterecords)"
---
...
탄소크레딧은(는) 산림 ESG 생태계에서 독립적으로 설명·판단되어야 하는 개념이다. 원문은 다음과 같이 이 구조적 역할을 뒷받침한다: “| 3 | `03_CCM_VCM_배출권_크레딧_상쇄_시장생태계.md` | 규제·자발적 시장과 단위·사용행위 구분 | 검증된 종합문서 |”

## Boundary

- IS: 탄소크레딧 자체의 정의, 역할, 근거, 상태를 다루는 개념.
...
`CARBON_CREDIT` definesGoal -> [탄소크레딧 Goal](../_goal/carbon_credit_goal.md).
