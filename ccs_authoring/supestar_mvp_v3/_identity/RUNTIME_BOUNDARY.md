...
description: "Runtime 경계의 산림 ESG 문맥상 의미와 경계를 정의한다."
...
fragmentedFrom: none
collapsedFrom: none
sequencePreviousIdentity: "[RUN_SKILL](../_artifact/stage3_knowledge_chain_ordering_artifact.md#orderedcandidaterecords)"
sequenceNextIdentity: "[RUN_RECORD](../_artifact/stage3_knowledge_chain_ordering_artifact.md#orderedcandidaterecords)"
---
...
Runtime 경계은(는) 산림 ESG 생태계에서 독립적으로 설명·판단되어야 하는 개념이다. 원문은 다음과 같이 이 구조적 역할을 뒷받침한다: “6. 제품 목적에 필요한 부분만 선택해 Runtime 경계로 배포한다.”

## Boundary

- IS: Runtime 경계 자체의 정의, 역할, 근거, 상태를 다루는 개념.
...
`RUNTIME_BOUNDARY` definesGoal -> [Runtime 경계 Goal](../_goal/runtime_boundary_goal.md).
