...
description: "Governance Context의 산림 ESG 문맥상 의미와 경계를 정의한다."
...
fragmentedFrom: none
collapsedFrom: none
sequencePreviousIdentity: "[COMMON_CONTEXT](../_artifact/stage3_knowledge_chain_ordering_artifact.md#orderedcandidaterecords)"
sequenceNextIdentity: "[BROWSER_EVIDENCE_UI](../_artifact/stage3_knowledge_chain_ordering_artifact.md#orderedcandidaterecords)"
---
...
Governance Context은(는) 산림 ESG 생태계에서 독립적으로 설명·판단되어야 하는 개념이다. 원문은 다음과 같이 이 구조적 역할을 뒷받침한다: “10. 승인된 개선만 다음 실행의 Common Context 또는 Governance Context에 반영한다.”

## Boundary

- IS: Governance Context 자체의 정의, 역할, 근거, 상태를 다루는 개념.
...
`GOVERNANCE_CONTEXT` definesGoal -> [Governance Context Goal](../_goal/governance_context_goal.md).
