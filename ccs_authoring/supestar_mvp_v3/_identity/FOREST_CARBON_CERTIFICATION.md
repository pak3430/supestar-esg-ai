---
name: FOREST_CARBON_CERTIFICATION
description: "산림탄소 인증의 산림 ESG 문맥상 의미와 경계를 정의한다."
...
fragmentedFrom: none
collapsedFrom: none
sequencePreviousIdentity: "[FOREST_CARBON_VERIFICATION](../_artifact/stage3_knowledge_chain_ordering_artifact.md#orderedcandidaterecords)"
sequenceNextIdentity: "[FOREST_CARBON_REGISTRY](../_artifact/stage3_knowledge_chain_ordering_artifact.md#orderedcandidaterecords)"
---
...
산림탄소 인증은(는) 산림 ESG 생태계에서 독립적으로 설명·판단되어야 하는 개념이다. 원문은 다음과 같이 이 구조적 역할을 뒷받침한다: “- 공식 인증의 자동판정”

## Boundary

- IS: 산림탄소 인증 자체의 정의, 역할, 근거, 상태를 다루는 개념.
...
`FOREST_CARBON_CERTIFICATION` definesGoal -> [산림탄소 인증 Goal](../_goal/forest_carbon_certification_goal.md).
