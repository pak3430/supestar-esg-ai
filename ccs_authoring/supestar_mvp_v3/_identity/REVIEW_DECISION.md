...
description: "REVIEW 판정의 산림 ESG 문맥상 의미와 경계를 정의한다."
...
fragmentedFrom: none
collapsedFrom: none
sequencePreviousIdentity: "[PROCEED_DECISION](../_artifact/stage3_knowledge_chain_ordering_artifact.md#orderedcandidaterecords)"
sequenceNextIdentity: "[STOP_DECISION](../_artifact/stage3_knowledge_chain_ordering_artifact.md#orderedcandidaterecords)"
---
...
REVIEW 판정은(는) 산림 ESG 생태계에서 독립적으로 설명·판단되어야 하는 개념이다. 원문은 다음과 같이 이 구조적 역할을 뒷받침한다: “- 법률·세무·계약에 관한 미확정 추정: 공식 근거가 확인되지 않은 주장은 REVIEW 또는 STOP 대상으로 유지한다.”

## Boundary

- IS: REVIEW 판정 자체의 정의, 역할, 근거, 상태를 다루는 개념.
...
- sourceLineRanges: L41-L41
- sourceSha256: d74f3ef40212a243697da58d0474ca5971780dcbe99a71e0d897f3477119f56f

## Skill Derivation

`REVIEW_DECISION` definesGoal -> [REVIEW 판정 Goal](../_goal/review_decision_goal.md).
