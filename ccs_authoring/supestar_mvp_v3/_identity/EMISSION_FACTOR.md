...
description: "배출계수의 산림 ESG 문맥상 의미와 경계를 정의한다."
...
fragmentedFrom: none
collapsedFrom: none
sequencePreviousIdentity: "[ACTIVITY_DATA](../_artifact/stage3_knowledge_chain_ordering_artifact.md#orderedcandidaterecords)"
sequenceNextIdentity: "[CO2E](../_artifact/stage3_knowledge_chain_ordering_artifact.md#orderedcandidaterecords)"
---
...
배출계수은(는) 산림 ESG 생태계에서 독립적으로 설명·판단되어야 하는 개념이다. 원문은 다음과 같이 이 구조적 역할을 뒷받침한다: “성과를 입증하려면 조직 경계·운영 경계·기준연도·활동자료·배출계수·단위가 필요하다.”

## Boundary

- IS: 배출계수 자체의 정의, 역할, 근거, 상태를 다루는 개념.
...
- sourceLineRanges: L35-L35
- sourceSha256: 5fa4e061b511955b6f1c4d95fd58ad54f454cd35d5b2dc6c5f00578db1fe3469

## Skill Derivation

`EMISSION_FACTOR` definesGoal -> [배출계수 Goal](../_goal/emission_factor_goal.md).
