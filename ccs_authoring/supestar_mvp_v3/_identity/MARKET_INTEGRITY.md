...
description: "시장 무결성의 산림 ESG 문맥상 의미와 경계를 정의한다."
...
fragmentedFrom: none
collapsedFrom: none
sequencePreviousIdentity: "[CARBON_OFFSET](../_artifact/stage3_knowledge_chain_ordering_artifact.md#orderedcandidaterecords)"
sequenceNextIdentity: "[BASELINE](../_artifact/stage3_knowledge_chain_ordering_artifact.md#orderedcandidaterecords)"
---
...
시장 무결성은(는) 산림 ESG 생태계에서 독립적으로 설명·판단되어야 하는 개념이다. 원문은 다음과 같이 이 구조적 역할을 뒷받침한다: “# 5. 시장 무결성과 그린워싱”

## Boundary

- IS: 시장 무결성 자체의 정의, 역할, 근거, 상태를 다루는 개념.
...
- sourceLineRanges: L54-L54
- sourceSha256: e9972fb77ea51a80592de8d208258495298ba7de487b3a19859212166d41e526

## Skill Derivation

`MARKET_INTEGRITY` definesGoal -> [시장 무결성 Goal](../_goal/market_integrity_goal.md).
