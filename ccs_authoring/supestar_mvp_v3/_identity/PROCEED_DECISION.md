---
name: PROCEED_DECISION
description: "PROCEED 판정의 산림 ESG 문맥상 의미와 경계를 정의한다."
...
fragmentedFrom: none
collapsedFrom: none
sequencePreviousIdentity: "[APPROVED_EXTERNAL_CLAIM](../_artifact/stage3_knowledge_chain_ordering_artifact.md#orderedcandidaterecords)"
sequenceNextIdentity: "[REVIEW_DECISION](../_artifact/stage3_knowledge_chain_ordering_artifact.md#orderedcandidaterecords)"
---
...
PROCEED 판정은(는) 산림 ESG 생태계에서 독립적으로 설명·판단되어야 하는 개념이다. 원문은 다음과 같이 이 구조적 역할을 뒷받침한다: “- 실행 상태: PROCEED, REVIEW 또는 STOP”

## Boundary

- IS: PROCEED 판정 자체의 정의, 역할, 근거, 상태를 다루는 개념.
...
- sourceLineRanges: L62-L62
- sourceSha256: cb6b20d918a96ca8757cfc97ccf49bc7c69ee9843234a98c1af4b2026196376c

## Skill Derivation

`PROCEED_DECISION` definesGoal -> [PROCEED 판정 Goal](../_goal/proceed_decision_goal.md).
