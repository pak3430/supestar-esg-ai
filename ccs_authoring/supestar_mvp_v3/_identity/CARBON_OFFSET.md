---
name: CARBON_OFFSET
description: "상쇄의 산림 ESG 문맥상 의미와 경계를 정의한다."
...
fragmentedFrom: none
collapsedFrom: none
sequencePreviousIdentity: "[CARBON_CREDIT](../_artifact/stage3_knowledge_chain_ordering_artifact.md#orderedcandidaterecords)"
sequenceNextIdentity: "[MARKET_INTEGRITY](../_artifact/stage3_knowledge_chain_ordering_artifact.md#orderedcandidaterecords)"
---
...
상쇄은(는) 산림 ESG 생태계에서 독립적으로 설명·판단되어야 하는 개념이다. 원문은 다음과 같이 이 구조적 역할을 뒷받침한다: “| 3 | `03_CCM_VCM_배출권_크레딧_상쇄_시장생태계.md` | 규제·자발적 시장과 단위·사용행위 구분 | 검증된 종합문서 |”

## Boundary

- IS: 상쇄 자체의 정의, 역할, 근거, 상태를 다루는 개념.
...
`CARBON_OFFSET` definesGoal -> [상쇄 Goal](../_goal/carbon_offset_goal.md).
