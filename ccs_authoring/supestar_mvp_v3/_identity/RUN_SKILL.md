---
name: RUN_SKILL
description: "Run Skill의 산림 ESG 문맥상 의미와 경계를 정의한다."
...
fragmentedFrom: none
collapsedFrom: none
sequencePreviousIdentity: "[BUILD_SKILL](../_artifact/stage3_knowledge_chain_ordering_artifact.md#orderedcandidaterecords)"
sequenceNextIdentity: "[RUNTIME_BOUNDARY](../_artifact/stage3_knowledge_chain_ordering_artifact.md#orderedcandidaterecords)"
---
...
Run Skill은(는) 산림 ESG 생태계에서 독립적으로 설명·판단되어야 하는 개념이다. 원문은 다음과 같이 이 구조적 역할을 뒷받침한다: “7. Run Skill이 실제 사용자 입력을 판단하고 정해진 행동을 수행한다.”

## Boundary

- IS: Run Skill 자체의 정의, 역할, 근거, 상태를 다루는 개념.
...
- sourceLineRanges: L25-L25
- sourceSha256: cb6b20d918a96ca8757cfc97ccf49bc7c69ee9843234a98c1af4b2026196376c

## Skill Derivation

`RUN_SKILL` definesGoal -> [Run Skill Goal](../_goal/run_skill_goal.md).
