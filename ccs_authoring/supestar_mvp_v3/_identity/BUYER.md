---
name: BUYER
description: "구매자의 산림 ESG 문맥상 의미와 경계를 정의한다."
...
fragmentedFrom: none
collapsedFrom: none
sequencePreviousIdentity: "[SELLER](../_artifact/stage3_knowledge_chain_ordering_artifact.md#orderedcandidaterecords)"
sequenceNextIdentity: "[INTERMEDIARY](../_artifact/stage3_knowledge_chain_ordering_artifact.md#orderedcandidaterecords)"
---
...
구매자은(는) 산림 ESG 생태계에서 독립적으로 설명·판단되어야 하는 개념이다. 원문은 다음과 같이 이 구조적 역할을 뒷받침한다: “판매자·구매자·중개자·결제사업자: 단위, 권한, 계약, 대금, 이전과 증빙의 책임을 나눈다.”

## Boundary

- IS: 구매자 자체의 정의, 역할, 근거, 상태를 다루는 개념.
...
`BUYER` definesGoal -> [구매자 Goal](../_goal/buyer_goal.md).
