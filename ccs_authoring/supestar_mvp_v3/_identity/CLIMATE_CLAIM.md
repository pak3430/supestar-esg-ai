---
name: CLIMATE_CLAIM
description: "기후 주장의 산림 ESG 문맥상 의미와 경계를 정의한다."
...
기후 주장은(는) 산림 ESG 생태계에서 독립적으로 설명·판단되어야 하는 개념이다. 원문은 다음과 같이 이 구조적 역할을 뒷받침한다: “사업 설계·방법론 → 기준선·추가성 → 모니터링·검증 → 발행·등록 → 구매·이전 → 소각·사용완료 → 기후 주장. 자발성은 검증과 책임이 없다는 뜻이 아니다.”

## Boundary

- IS: 기후 주장 자체의 정의, 역할, 근거, 상태를 다루는 개념.
...
`CLIMATE_CLAIM` definesGoal -> [기후 주장 Goal](../_goal/climate_claim_goal.md).
`CLIMATE_CLAIM` definesGoal -> [탄소시장·단위·사용행위 비교 Goal](../_goal/carbon_market_unit_comparison_goal.md).
