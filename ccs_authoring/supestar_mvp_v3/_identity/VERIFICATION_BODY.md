...
description: "검증기관의 산림 ESG 문맥상 의미와 경계를 정의한다."
...
fragmentedFrom: none
collapsedFrom: none
sequencePreviousIdentity: "[FOREST_CARBON_CENTER](../_artifact/stage3_knowledge_chain_ordering_artifact.md#orderedcandidaterecords)"
sequenceNextIdentity: "[SELLER](../_artifact/stage3_knowledge_chain_ordering_artifact.md#orderedcandidaterecords)"
---
...
검증기관은(는) 산림 ESG 생태계에서 독립적으로 설명·판단되어야 하는 개념이다. 원문은 다음과 같이 이 구조적 역할을 뒷받침한다: “검증기관: 모니터링과 산정결과를 독립적으로 검토한다.”

## Boundary

- IS: 검증기관 자체의 정의, 역할, 근거, 상태를 다루는 개념.
...
- sourceLineRanges: L53-L53
- sourceSha256: c1dd5385f2fb59e4f1c914080206db591915fc6dca31f332b94eb2b1b0ac8eea

## Skill Derivation

`VERIFICATION_BODY` definesGoal -> [검증기관 Goal](../_goal/verification_body_goal.md).
