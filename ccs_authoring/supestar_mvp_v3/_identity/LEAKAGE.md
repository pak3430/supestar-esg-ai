---
name: LEAKAGE
description: "누출의 산림 ESG 문맥상 의미와 경계를 정의한다."
...
fragmentedFrom: none
collapsedFrom: none
sequencePreviousIdentity: "[ADDITIONALITY](../_artifact/stage3_knowledge_chain_ordering_artifact.md#orderedcandidaterecords)"
sequenceNextIdentity: "[PERMANENCE](../_artifact/stage3_knowledge_chain_ordering_artifact.md#orderedcandidaterecords)"
---
...
누출은(는) 산림 ESG 생태계에서 독립적으로 설명·판단되어야 하는 개념이다. 원문은 다음과 같이 이 구조적 역할을 뒷받침한다: “기준선·추가성·누출·영속성·역전 위험을 검토한다.”

## Boundary

- IS: 누출 자체의 정의, 역할, 근거, 상태를 다루는 개념.
...
`LEAKAGE` definesGoal -> [누출 Goal](../_goal/leakage_goal.md).
