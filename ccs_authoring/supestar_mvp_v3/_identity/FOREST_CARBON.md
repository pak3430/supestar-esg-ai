---
name: FOREST_CARBON
description: "산림탄소의 산림 ESG 문맥상 의미와 경계를 정의한다."
...
fragmentedFrom: none
collapsedFrom: none
sequencePreviousIdentity: "[CLIMATE_CLAIM](../_artifact/stage3_knowledge_chain_ordering_artifact.md#orderedcandidaterecords)"
sequenceNextIdentity: "[FOREST_CARBON_SINK](../_artifact/stage3_knowledge_chain_ordering_artifact.md#orderedcandidaterecords)"
---
...
산림탄소은(는) 산림 ESG 생태계에서 독립적으로 설명·판단되어야 하는 개념이다. 원문은 다음과 같이 이 구조적 역할을 뒷받침한다: “| 1 | `01_ESG_산림탄소_전체생태계_기준서.md` | 전체 범위·7단계·참여자·산출물 기준 | 검증된 종합문서 |”

## Boundary

- IS: 산림탄소 자체의 정의, 역할, 근거, 상태를 다루는 개념.
...
`FOREST_CARBON` definesGoal -> [산림탄소 Goal](../_goal/forest_carbon_goal.md).
