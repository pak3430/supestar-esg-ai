---
name: ESG
description: "ESG의 산림 ESG 문맥상 의미와 경계를 정의한다."
...
fragmentedFrom: none
collapsedFrom: none
sequencePreviousIdentity: "none"
sequenceNextIdentity: "[ENVIRONMENTAL_RESPONSIBILITY](../_artifact/stage3_knowledge_chain_ordering_artifact.md#orderedcandidaterecords)"
---
...
ESG은(는) 산림 ESG 생태계에서 독립적으로 설명·판단되어야 하는 개념이다. 원문은 다음과 같이 이 구조적 역할을 뒷받침한다: “run_scope: forest_esg_concept_v1”

## Boundary

- IS: ESG 자체의 정의, 역할, 근거, 상태를 다루는 개념.
