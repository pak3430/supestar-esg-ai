---
name: FOREST_OWNER
description: "산주의 산림 ESG 문맥상 의미와 경계를 정의한다."
...
fragmentedFrom: none
collapsedFrom: none
sequencePreviousIdentity: "[REGISTRY_STATUS](../_artifact/stage3_knowledge_chain_ordering_artifact.md#orderedcandidaterecords)"
sequenceNextIdentity: "[PROJECT_OPERATOR](../_artifact/stage3_knowledge_chain_ordering_artifact.md#orderedcandidaterecords)"
---
...
산주은(는) 산림 ESG 생태계에서 독립적으로 설명·판단되어야 하는 개념이다. 원문은 다음과 같이 이 구조적 역할을 뒷받침한다: “산주·사업자: 적법한 권리와 사업계획, 실행·모니터링 자료를 제시한다.”

## Boundary

- IS: 산주 자체의 정의, 역할, 근거, 상태를 다루는 개념.
...
- sourceLineRanges: L49-L49
- sourceSha256: c1dd5385f2fb59e4f1c914080206db591915fc6dca31f332b94eb2b1b0ac8eea

## Skill Derivation

`FOREST_OWNER` definesGoal -> [산주 Goal](../_goal/forest_owner_goal.md).
